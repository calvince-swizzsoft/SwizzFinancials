...
const navItems: NavItem[] = [
  ...
  */
  /*{
    ...
    icon: <PageIcon />,
    subItems: [
      { name: "Employee Directory", path: "/EmployeeDirectory", pro: false },
      { name: "Roles Permissions", path: "/RolesPermissions", pro: false },
      { name: "Attendance Tracking", path: "/AttendanceTracking", pro: false },
      { name: "Scheduling and Rostering", path: "/SchedulingRostering", pro: false },
      { name: "Payroll Compensation", path: "/PayrollCompensation", pro: false },
...
const AppSidebar: React.FC = () => {
  ...
  return (
    ...
    style={{
      boxShadow: "6px 0 10px rgba(101, 101, 101, 0.1)", // right-only shadow
    }}
    >
      <div
        className={`py-8 flex ${
          ...
          {isExpanded || isHovered || isMobileOpen ? (
            <div style={{display:"flex", alignItems:"center", justifyContent:"space-between"}}>
              ...
              <img
                ...
                height={10}
              />
              <h1 style={{marginLeft:"20px", fontSize:"21px", fontWeight:"600"}}>United kenya Club</h1>
            </div>
          ) : (
            <img
              src={logo}
      ...
      <hr/>
      <div className="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar" style={{color:"#fff"}}>
        <nav className="mb-6" style={{color:"#fff"}}>
          <div className="flex flex-col gap-4">
            <div>
              <h2
                className={`mb-4 text-xs uppercase flex leading-[20px] text-[#d6e4ff] ${
                  !isExpanded && !isHovered
                    ? "lg:justify-center"
                    : "justify-start"
                }`}
