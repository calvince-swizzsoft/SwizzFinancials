...
export default function PageIntro() {
  ...
  const handleSave = async () => {
    ...
    setError("");
    try {
      await axios.post("http://197.232.170.121:8594/api/club/postMember", formData);
      closeModal();
            ...
            <div className="custom-scrollbar h-[400px] overflow-y-auto px-2 pb-2">
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                  ...
                  <Input name="membershipStatus" value={formData.membershipStatus} onChange={handleChange} />
                </div>
                <div>
