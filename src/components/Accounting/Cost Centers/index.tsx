...
export default function CostCenter() {
  ...
  return (
    <div className="min-h-screen rounded-2xl border border-gray-200 bg-white px-5 py-7 dark:border-gray-800 dark:bg-white/[0.03] xl:px-10 xl:py-12" style={{boxShadow: "0 4px 6px rgba(0, 0, 0, 0.3)"}}>
      <div className="mx-auto w-full max-w-[1000px]">
        <h3 className="mb-4 text-center font-semibold text-gray-800 text-theme-xl dark:text-white/90 sm:text-2xl">
          Cost Centers
        </h3>
        <p className="text-sm text-center text-gray-500 dark:text-gray-400 sm:text-base mb-6">
