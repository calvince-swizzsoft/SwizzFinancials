...
const LedgerForm: React.FC = () => {
  ...
  const handleEntryChange = (
    ...
    // infer type: if key has "date", format as date string
    ...
    return (
      <div key={key} className="flex flex-col">
        ...
        <input
          ...
          value={typeof value === "boolean" ? undefined : isDate && value ? value.substring(0, 10) : value}
      ...
      <h3 className="text-xl font-semibold mt-6 mb-2">Ledger Entries</h3>
