...
// Temporarily disabled pages that depend on other backends
...
import PostingPage from "./components/Accounting/Posting";
import LedgerTransactionsPage from "./components/Accounting/Ledger";
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route element={<AppLayout />}>
            ...
            <Route index path="/Posting" element={<PostingPage/>} />
            <Route index path="/BankLinkage" element={<BankLinkages/>} />
            <Route index path="/Invoice" element={<InvoiceComponent/>} />
            <Route path="/accounting/ledger/:id" element={<LedgerTransactionsPage />} />
